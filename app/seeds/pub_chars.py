...
from app.models.public_character import PublicCharacter
...
def seed_pub_chars():
    ...
    for each in each_icon:
        result.append(PublicCharacter(avatar=each, character_name=fake.name(), character_label="default label here",
